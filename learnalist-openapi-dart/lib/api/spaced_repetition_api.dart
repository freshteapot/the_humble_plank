...
class SpacedRepetitionApi {
  ...
  Future<Response> spacedRepetitionAddListToOvertimeWithHttpInfo(Object body) async {
    Object postBody = body;
    ...
    // create path and map variables
    String path = "/spaced-repetition/overtime".replaceAll("{format}","json");
  ...
  ///
  /// Add for dripfeed (Slowly add this list for spaced repetition learning).
  Future<SpacedRepetitionOvertimeInfo> spacedRepetitionAddListToOvertime(Object body) async {
    Response response = await spacedRepetitionAddListToOvertimeWithHttpInfo(body);
    if(response.statusCode >= 400) {
      throw ApiException(response.statusCode, _decodeBodyBytes(response));
    } else if(response.body != null) {
      return apiClient.deserialize(_decodeBodyBytes(response), 'SpacedRepetitionOvertimeInfo') as SpacedRepetitionOvertimeInfo;
    } else {
      return null;
    }
  }
  ...
  Future spacedRepetitionOvertimeIsActiveWithHttpInfo(String uuid) async {
    Object postBody;
    ...
    // create path and map variables
    String path = "/spaced-repetition/overtime/active/{uuid}".replaceAll("{format}","json").replaceAll("{" + "uuid" + "}", uuid.toString());
  ...
  ///
  /// Ugly light url to check if list active for this user.
  Future spacedRepetitionOvertimeIsActive(String uuid) async {
    Response response = await spacedRepetitionOvertimeIsActiveWithHttpInfo(uuid);
    if(response.statusCode >= 400) {
      throw ApiException(response.statusCode, _decodeBodyBytes(response));
    } else if(response.body != null) {
    } else {
  ...
  Future<Response> spacedRepetitionRemoveListFromOvertimeWithHttpInfo(SpacedRepetitionOvertimeInputBase spacedRepetitionOvertimeInputBase) async {
    Object postBody = spacedRepetitionOvertimeInputBase;

    // verify required params are set
    if(spacedRepetitionOvertimeInputBase == null) {
     throw ApiException(400, "Missing required param: spacedRepetitionOvertimeInputBase");
    }
  ...
  ///
  /// Remove list from dripfeed.
  Future<HttpResponseMessage> spacedRepetitionRemoveListFromOvertime(SpacedRepetitionOvertimeInputBase spacedRepetitionOvertimeInputBase) async {
    Response response = await spacedRepetitionRemoveListFromOvertimeWithHttpInfo(spacedRepetitionOvertimeInputBase);
    if(response.statusCode >= 400) {
      throw ApiException(response.statusCode, _decodeBodyBytes(response));
    } else if(response.body != null) {
